...
class OsobljeProvider with ChangeNotifier{
  ...
  Future<dynamic> get(dynamic searchObject) async {
    var url = Uri.parse("${BaseProvider.baseUrl}/Osoblje");
  ...
  print('Response body: ${response.body}');
    ...
    final url = Uri.parse("${BaseProvider.baseUrl}/Osoblje/$id"); // Adjust the URL as needed
